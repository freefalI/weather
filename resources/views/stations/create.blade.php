...
@section('title', __('station.create'))

@section('content')
<div class="row justify-content-center">
    <div class="col-md-6">
        <div class="card">
            <div class="card-header">{{ __('station.create') }}</div>
            <form method="POST" action="{{ route('stations.store') }}" accept-charset="UTF-8">
                {{ csrf_field() }}
                <div class="card-body">
                ...
                <div class="card-footer">
                    <input type="submit" value="{{ __('station.create') }}" class="btn btn-success">
                    <a href="{{ route('stations.index') }}" class="btn btn-link">{{ __('app.cancel') }}</a>
                </div>
            </form>
        </div>
    </div>
